...
class QuestionViewController: UIViewController {
    ...
    var questions: [Question] = [
        ...
        Question(text: "Which activities do you anjoy?",
                 type: .multiple,
                 answers: [
        ...
        Question(text: "How much do you enjoy car rides?",
                 ...
                 answers: [
                    ...
                    Answer(text: "Iget a little nervous", type: .rabbit),
    ...
    @IBAction func rangedAnswerButtonPressed() {
        let currenAnswers = questions[questionIndex].answers
        let index = Int(round(rangedSlider.value * Float(currenAnswers.count - 1)))
        answerChosen.append(currenAnswers[index])
        nextQuestion()
    }
    ...
    func nextQuestion() {
        ...
        if questionIndex < questions.count {
            ...
            performSegue(withIdentifier: "ResultaSegue", sender: nil)
        }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ResultaSegue" {
